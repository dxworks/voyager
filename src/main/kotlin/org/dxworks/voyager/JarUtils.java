...
public class JarUtils {
    ...
    public static void main(String[] args) throws IOException {
        JarFile fromJar = jarForClass(JarUtils.class, null);
        if (fromJar != null) {
            copyResourcesToDirectory(fromJar, "asd", "/Users/darius/asd");
        } else {
            String folder = JarUtils.class.getResource("/asd").getFile();
            FileUtils.copyDirectory(Paths.get(folder).toFile(), Paths.get("/Users/darius/asd").toFile());
        }
    }
}
